...
if ($_POST) {
   ...
   $sql = "INSERT INTO cars (brand, model, location, availability, price, picture) VALUES ('$brand','$model', '$location', '$availability', '$price','$picture')";
    if($conn->query($sql) === TRUE) {
       echo "<p>New Record Successfully Created</p><hr>" ;
