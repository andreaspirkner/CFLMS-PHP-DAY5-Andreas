...
//$resCar = mysqli_query($conn, "SELECT * FROM cars WHERE availability = 'yes'");
...
<div class="parallax_section2 parallax_image">
  <div class="row">
            ...
            "<div class='card border-dark'>
                <div class='card-body'>
                                <hr>
                                <h6 class='card-text'>Booking Period:</h6><p>" .$row['booking_date_start']." <span>until </span>".$row['booking_date_end' ]."</p>
                                <h6 class='card-text'>Booking ID:</h6><p>" .$row['booking_id']."</p>
                                <h6 class='card-text'>User ID:</h6><p>" .$row['fk_user_id']."</p>
                                <h6 class='card-text'>Car ID:</h6><p>" .$row['fk_car_id']."</p>
                                <hr>
                                
                                <a href='admin.php?id=" .$row['id']."'><button class='btn btn-dark border border-dark' type='button'>Admin</button></a><hr>
                </div><!--END BODY-->
            </div><!--END BOOKING PERIOD-->";
            }
                     } else  {
